            ...
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12" style="min-height: 260px">
                        <ul class="site-stats">
                            <li class="span12" style="background-color: #eee;"><strong>Nome: <?php echo $usuario->nome?></strong></li>
                            <li class="span12" style="margin-left: 0;background-color: #eee;"><strong>Telefone: <?php echo $usuario->telefone?></strong></li>
                            <li class="span12" style="margin-left: 0;background-color: #eee;"><strong>Email: <?php echo $usuario->email?></strong></li>
                            <li class="span12" style="margin-left: 0;background-color: #eee;"><strong>Nível: <?php if($usuario->nivel == "1"){echo 'Administrador';}else{echo 'Técnico';} ?></strong></li>
                        </ul>
                    </div>
