...
<table class="table table-bordered ">
    ...
    <tbody>
        <?php foreach ($results as $r) {
            ...
            echo '<td>
                      <a href="'.base_url().'index.php/servicos/editar/'.$r->idServicos.'" class="btn btn-info tip-top" title="Editar Serviço"><i class="icon-pencil icon-white"></i></a>
                      <a href="#modal-excluir" role="button" data-toggle="modal" servico="'.$r->idServicos.'" class="btn btn-danger tip-top" title="Excluir Serviço"><i class="icon-remove icon-white"></i></a>  
                  </td>';
            echo '</tr>';
        }?>
        <tr>
