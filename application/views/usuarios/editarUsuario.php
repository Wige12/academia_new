        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        <label  class="control-label">Nível de Acesso<span class="required">*</span></label>
                        <div class="controls">
                            <select name="nivel" id="nivel">
                            <?php if($result->nivel == '1'){$admin = 'selected'; $tec = '';}else{$admin = ''; $tec = 'selected';} ?>
                                <option value="1" <?php echo $admin; ?>>Administrador</option>
                                <option value="2" <?php echo $tec; ?>>Funcionário</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <div class="span12">
                            <div class="span6 offset3">
                                ...
                                <a href="<?php echo base_url() ?>index.php/usuarios" id="" class="btn"><i class="icon-arrow-left"></i> Cancelar</a>
                            </div>
                        </div>
                    </div>
