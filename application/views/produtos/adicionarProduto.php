            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="unidade" type="text" name="unidade" value="<?php echo set_value('unidade'); ?>UN"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="porcentagem" class="money" type="text" name="porcentagem" value="<?php echo set_value('porcentagem'); ?>"  />
                        </div>
                    </div>
