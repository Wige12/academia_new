<div class="accordion" id="collapse-group">
    <div class="accordion-group widget-box">
        <div class="accordion-heading">
            ...
            <div class="buttons">
                    <a title="Icon Title" class="btn btn-mini btn-info" href="<?php echo base_url()?>index.php/produtos/editar/<?php echo $result->idProdutos?>"><i class="icon-pencil icon-white"></i> Editar</a>
                </div>
            </div>
        </div>
