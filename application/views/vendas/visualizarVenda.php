    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Venda</h5>
                <div class="buttons">
                    <a title="Icon Title" class="btn btn-mini btn-info" href="<?php echo base_url()?>index.php/vendas/editar/<?php echo $result->idVendas?>"><i class="icon-pencil icon-white"></i> Editar</a>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function Popup(data)
        {
            ...
            mywindow.document.write('<html><head><title>Venda Nº <?php echo $result->idVendas?> - <?php echo $result->nomeCliente?></title>');
