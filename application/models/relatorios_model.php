...
class Relatorios_model extends CI_Model {
    ...
    public function etiquetas($de,$ate){
    ...
    public function caixaRapid(){
        ...
        $query = "SELECT * FROM caixa WHERE dataabertura BETWEEN ? and ? ORDER BY dataabertura";
        return $this->db->query($query, array($dataInicial,$dataFinal))->result();
    }

    public function caixaCustom($dataInicial, $dataFinal){
    ...
    public function financeiroRapid(){
        ...
        $dataInicial = date('Y-m-01');
        $dataFinal = date("Y-m-t");
        $query = "SELECT * FROM lancamentos WHERE data_vencimento BETWEEN ? and ? ORDER BY data_vencimento";
        return $this->db->query($query, array($dataInicial,$dataFinal))->result();
    }
